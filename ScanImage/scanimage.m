...
state.internal.guinames={'roiCycleGUI','imageGUI','channelGUI','basicConfigurationGUI','advancedConfigurationGUI','motorGUI',...
        'mainControls','standardModeGUI','userFcnGUI','cycleControls','userPreferenceGUI','powerControl','powerTransitions', ... %VI102909A
        'uncagingPulseImporter', 'powerBoxStepper', 'uncagingMapper', 'laserFunctionPanel'};
...
%%%VI111708A: Allow bidi scanning if user set 'secret' INI file setting
if state.internal.bidiScanEnabled
    set(gh.advancedConfigurationGUI.cbBidirectionalScan,'Visible','on');
end
%%%%%%%%%%%%%%%%%%%%
...
if ~state.init.eom.pockelsOn %VI081308A
