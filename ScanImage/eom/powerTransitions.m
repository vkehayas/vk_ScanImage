...
global state;
    ...
    if state.init.eom.powerTransitions.framesTimeUnits
        timeInCurrentUnits = timeInMs / (1000*state.acq.msPerLine*state.acq.linesPerFrame);
    elseif state.init.eom.powerTransitions.linesTimeUnits
        timeInCurrentUnits = timeInMs / (1000*state.acq.msPerLine);
    else
...
global state;
    ...
    if state.init.eom.powerTransitions.framesTimeUnits
        timeInMs = timeInCurrentUnits * 1000*state.acq.msPerLine * state.acq.linesPerFrame;
    elseif state.init.eom.powerTransitions.linesTimeUnits
        timeInMs = timeInCurrentUnits * 1000*state.acq.msPerLine;
    else
