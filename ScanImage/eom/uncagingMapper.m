...
elseif state.init.eom.uncagingMapper.duration + state.init.eom.uncagingMapper.x * 1000 * state.acq.fillFraction * state.acq.msPerLine > ...
        1000 * state.acq.fillFraction * state.acq.msPerLine
    updateGUIByGlobal('state.init.eom.uncagingMapper.duration', 'Value', 1000 * state.acq.fillFraction * state.acq.msPerLine ...
        - state.init.eom.uncagingMapper.x * 1000 * state.acq.fillFraction * state.acq.msPerLine);
end
...
updateGUIByGlobal('state.init.eom.uncagingMapper.autoDuration', 'Value', 10 * round(100 * 1000 * state.acq.msPerLine / state.init.eom.uncagingMapper.numberOfPixels) / 1000);
...
if state.init.eom.uncagingMapper.autoDuration > (1000 * state.acq.msPerLine / state.init.eom.uncagingMapper.numberOfPixels)
    updateGUIByGlobal('state.init.eom.uncagingMapper.autoDuration', 'Value', 10 * round(100 * 1000 * state.acq.msPerLine / state.init.eom.uncagingMapper.numberOfPixels) / 1000);
end
...
updateGUIByGlobal('state.init.eom.uncagingMapper.duration', 'Value', ...
    (x(2) - x(1)) / state.acq.pixelsPerLine * (1000 * state.acq.msPerLine * state.acq.fillFraction), 'Callback', 1);
    ...
    for i = 1 : state.init.maximumNumberOfInputChannels
        state.init.eom.uncagingMapper.pixelLineHandles(i) = ...
            line([state.init.eom.uncagingMapper.x (state.init.eom.uncagingMapper.x + state.init.eom.uncagingMapper.duration / ...
               (1000 * state.acq.msPerLine * state.acq.fillFraction))] .* state.acq.pixelsPerLine, ...
