...
% Last Modified by GUIDE v2.5 31-Aug-2010 13:34:26

%JL113007A reset slider value to 50 for Matlab 7
...
if getLocal(progmanager, hObject, 'whiteValue') > 65000 %%VK170906A%%
    setLocal(progmanager, hObject, 'whiteValue', 65000); %%VK170906A%%
elseif getLocal(progmanager, hObject, 'whiteValue') < 1
    setLocal(progmanager, hObject, 'whiteValue', 1);
end

if getLocal(progmanager, hObject, 'blackValue') > 64999 %%VK170906A%%
    setLocal(progmanager, hObject, 'blackValue', 64999); %%VK170906A%%
...
setLocal(progmanager, hObject, 'frameSliderValue', 50);
...
if getGlobal(progmanager, 'framesLocked', 'StackBrowserControl', 'stackBrowserControl')
    ...
    if getLocal(progmanager, hObject, 'frameNumber') == frames ...
            & increment > 0
        return;
    elseif getLocal(progmanager, hObject, 'frameNumber') == 1 ...
            & increment < 0
        return;
    end
...
out = {
       ...
       'whiteValue', 2000, 'Class', 'Numeric', 'Min' 1, 'Max', 65000, 'Gui', 'whiteValueSlider', 'Gui', 'whiteValueText', ... %%VK170906B
       'blackValue', 0, 'Class', 'Numeric', 'Min' 0, 'Max', 64999, 'Gui', 'blackValueSlider', 'Gui', 'blackValueText', ... %%VK170906B
       ...
       'frameSliderValue', 50, 'Class', 'Numeric', 'Gui', 'frameSlider', 'Min', 1, 'Max', 100, ...
...%       'lastFrameSliderValue', 1, 'Class', 'Numeric', ...
       'roiRectangle', [], ...
       'shiftStepSize', 50, 'Class', 'Numeric', 'Gui', 'shiftStepSize', ...
       'zoomSliderValue', 50, 'Class', 'Numeric', 'Gui', 'zoomFactorSlider', 'Min', 1, 'Max', 100, ...
...
setLocal(progmanager, hObject, 'zoomSliderValue', 50);
